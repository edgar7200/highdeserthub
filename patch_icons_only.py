...
old = '''                      <span style={{display:"inline-flex",alignItems:"center",gap:"0.3rem",color:"#C13584",padding:"0.2rem 0.6rem",background:"rgba(193,53,132,0.1)",border:"1px solid rgba(193,53,132,0.3)",borderRadius:"2rem",fontSize:"0.75rem",fontWeight:600}}>
...
new = '''                      <span style={{display:"inline-flex",alignItems:"center",color:"#C13584",padding:"0.25rem",background:"rgba(193,53,132,0.1)",border:"1px solid rgba(193,53,132,0.3)",borderRadius:"2rem"}}>
