              ...
              >
                ...
                <div className="biz-meta">
                  ...
                  {biz.instagram && ['standard','featured','premium'].includes(biz.tier) && (
                    <a href={`https://instagram.com/${biz.instagram.replace('@','')}`} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{display:"inline-flex",alignItems:"center",color:"#C13584",marginLeft:"0.1rem"}}>
